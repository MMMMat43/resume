...
- 🧭 Agile / Scrum / Kanban
----
- Специалист по 1С (Junior)
- Изучал и сопровождал 1С:Предприятие, участвовал в настройке, тестировании обновлений и интеграции с внешними сервисами.
- Оформлял документацию, фиксировал баги, занимался разработкой, получал опыт работы с основными модулями.
- Готов развиваться в направлении автоматизации и оптимизации бизнес-процессов.
